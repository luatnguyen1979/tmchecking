                    ...
                    <div class="row">
                        ...
                        <div class="col-9 text-left">
                            <form:select id="country" path="country"
                                ...
                                <form:option value="AX">Ãland Islands</form:option>                                <form:option value="AL">Albania</form:option>                               <form:option value="DZ">Algeria</form:option>
                                <form:option value="AS">American Samoa</form:option>
                                ...
                                <form:option value="CI">CÃ´te d'Ivoire</form:option>
                                <form:option value="HR">Croatia</form:option>
                                <form:option value="CU">Cuba</form:option>
                                <form:option value="CW">CuraÃ§ao</form:option>
                                ...
                                <form:option value="RE">RÃ©union</form:option>
                                ...
                                <form:option value="BL">Saint BarthÃ©lemy</form:option>
